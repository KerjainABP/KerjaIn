...
class PekerjakuPage extends StatefulWidget {
  @override
  _PekerjakuPageState createState() => _PekerjakuPageState();
}

class _PekerjakuPageState extends State<PekerjakuPage> {
                    ...
                    child: GridView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Kartu(
                          ...
                          onPressed: () =>
                              Get.toNamed('/lihatPekerja/${lowong.id}'),
